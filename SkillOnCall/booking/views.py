...
def book_service(request, provider_id):
    ...
    if request.method == 'POST':
        ...
        provider_email = service_provider.customer.user.email
        subject = "New Service Booking Request"
        message = f"Hello ,\n\nYou have a new service booking request from . \n\nDescription of the issue: \n\nPlease accept or decline the booking via your provider portal."
        from_email = settings.EMAIL_HOST_USER  # From email is the email you configured in settings.py

        try:
            send_mail(subject, message, from_email, [provider_email])
...
#             'description_of_problem': description_of_problem,
#             # 'services': services,
#             'accept_decline_url': 'http://your-site.com/accept-decline-url',  # Replace with your actual URL
